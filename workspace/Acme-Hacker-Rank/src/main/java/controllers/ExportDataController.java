...
public class ExportDataController extends AbstractController{
	...
	public @ResponseBody  void downloadFileHacker(HttpServletResponse resp) {
		...
		res+="Curriculas:";
		res += "\r\n\r\n";
		Collection<Curricula> cvs=this.curriculaService.findCurriculasByHackerId(actor.getId());

		for(Curricula cv:cvs){
			res += "----------------------------------------";
			res += "\r\n\r\n";
			res+="Curricula: "+"\r\n\r\n";
			res+="PersonalData: "+"\r\n\r\n"+ "GitHub profile: "+cv.getPersonalData().getGithubProfile()+"\r\n\r\n"+ "linkedIn: "+cv.getPersonalData().getLinkedIn()
					+"\r\n\r\n"+ "fullName: "+cv.getPersonalData().getFullName()
					+"\r\n\r\n"+ "statement: "+cv.getPersonalData().getStatement()
					+"\r\n\r\n"+ "phoneNumber: "+cv.getPersonalData().getPhoneNumber();
			res += "\r\n\r\n";
		...
		res+="Applications:";
		res += "\r\n\r\n";
		Collection<Application> apps=this.applicationService.findApplicationsByHackerId(actor.getId());
