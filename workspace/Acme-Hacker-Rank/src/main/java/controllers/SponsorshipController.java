...
//	@RequestMapping(value = "/listNope", method = RequestMethod.GET)
//	public ModelAndView listNope(@RequestParam int positionId) {
//		ModelAndView result = new ModelAndView("sponsorship/listNope");
//		Collection<Sponsorship> sponsorships;
//		Position position;
//		
//		try {
//			position = this.positionService.findOne(positionId);
//			sponsorships = position.getSponsorships();
//			
